...
export function getPlaylistPrompt(songs :String[]) {
  return `Here are my favourite songs: ${songs.toString()} Suggest a playlist of songs I would like given that I listen to these.`
}