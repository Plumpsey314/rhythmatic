export function getPrompt() {
  let prompt = ` Build a fast AI music chatbot. Recommend ten unique songs matching user query. Prioritize relevance, diversity, serendipity, and popularity/recency. Handle 'similar' queries, excluding specified artists. Return recommendations as JS arrays [song, artist].`
